    ...
    <nav className="flex items-center justify-between py-4 px-[5%] relative bg-[#111111]">
      ...
      {menuOpen && (
        <div className="absolute top-[70px] left-0 w-full bg-white shadow-md flex flex-col items-center gap-y-4 py-4 md:hidden z-50">
          ...
          <Link to="/menu" onClick={() => setMenuOpen(false)} className="text-gray-800 hover:text-blue-800">
            Menu
          </Link>
          <Link to="/outlets" onClick={() => setMenuOpen(false)} className="text-gray-800 hover:text-blue-800">
            Outlets
          </Link>
